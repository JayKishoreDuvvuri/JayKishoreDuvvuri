...
Languages and tools:
[selenium](https://www.selenium.dev/) webdriverio appium REST Assured cucumber cypress java javascript junit testng mocha jasmine jenkins docker git postman python pytest serenity-bdd katalon saucelabs browserstack selenoid spring boot
# 📊 GitHub Stats:
